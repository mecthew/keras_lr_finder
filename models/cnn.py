...
class CnnModel2D(Classifier):
    ...
    def init_model(self,
                   ...
                   max_layer_num=5,
                   **kwargs):
        # FIXME: keras sequential model is better than keras functional api, why???
        model = Sequential()
...
# Input of CNN1D is speech raw data， shape of each sample is (sample_rate*default_duration, 1)
